...
\newcommand{\myName}{Rafael Nogales Vaquero (alumno)\xspace}
\newcommand{\myProf}{Francisco Herrera Triguero  (tutor1)\xspace}
\newcommand{\myOtherProf}{Salvador García López (tutor2)\xspace}
